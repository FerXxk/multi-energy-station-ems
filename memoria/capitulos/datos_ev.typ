...
Esta capacidad de dispensación no debe confundirse con la capacidad de producción. El electrolizador de OASIS (200 kW, ≈50 kWh/kg, @cap-estado-arte) produce como máximo:
...
Debe tenerse presente al leer los resultados que los bloques de tanque del modelo emplean la ecuación de los gases ideales (@cap-estado-arte), que a estas presiones sobrestima la masa almacenada en torno a un 50 %. Las cifras de este balance, calculadas con densidades de gas real, son por tanto más exigentes que las que producirá la simulación: si el nivel del tanque de alta ya resulta ajustado en simulación, en una instalación real lo sería más.
