...
%#codegen
% Gestor de energia de la version C, la final. Parte de la version A y cambia dos
% cosas en las horas en que no hay sol suficiente. La primera es de quien sale la
% energia: mientras a la bateria le quede carga por encima de la reserva, es ella
% y no la red quien alimenta al electrolizador y al compresor. La segunda es
% cuando se produce hidrogeno: en vez de decidirlo hora a hora, mira las 24 horas
% siguientes, calcula cuantas horas de electrolizador hacen falta para llenar el
% tanque y cubrir la demanda que se espera, descuenta lo que dara el sol y
% produce solo en las horas mas baratas del dia. Del precio previsto solo usa el
% orden, no el valor. Los dos cambios se apagan con USAR_D1 y USAR_PLAN, y con
% los dos apagados se comporta igual que A.

%% Interruptores de los dos cambios respecto a A
USAR_D1   = true;
USAR_PLAN = true;    % a false se obtiene la variante C0, sin planificador
